...
namespace ExerciseTrackingAnalytics.Extensions
{
    public static class StringExtensions
    {
            ...
            string delimiter = "-")
        {
            ...
            var s = RemoveDiacritics(input);

#pragma warning disable CS8602 // Nullable value type may be null.
            if (forceLowercase)
                s = s.ToLower();

            // replace ampersands with "and"
            s = s.Replace("&", " and ");
#pragma warning restore CS8602 // Nullable value type may be null.
